    ...
    Posts: function () {
        ...
        this.get_all_items_pagination = function () {
            ...
            if ($('form.post-list input').val()) {
                ...
                /* Load first page */
                _this.ajax_get_all_items_pagination(1, $('.post_SB').val() );
            }

            $('body').on('click', '.pagination-nav li.active', function () {
                var page = $(this).attr('p');
                _this.ajax_get_all_items_pagination(page, $('.post_SB').val());
            });
            ...
            $(".post_search_text").keydown(function (e) {
                //if (e.keyCode == 13) {
                if ($('.post_SB').val() ==null){
                    error.append('<p style="color:red"; colspan="3"> *required</p>')
                }
                else
                _this.ajax_get_all_items_pagination(1, $('.post_SB').val());
                //}
